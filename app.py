        ...
        dcc.Tabs(
            ...
            children=[
                    ...
                    children=[
                        html.Div(
                            [
                                ...
                                html.P("Interactive visualization of Japanese Economy", style={"textAlign": "center"}),
                                html.P(
                                    "With Dash and Opendata", style={"textAlign": "center"}
                                ),
                            ],
                ...
                dcc.Tab(
                    ...
                    children=[
                        html.Div(
                            [html.H1("Hello!", style=title_font)], style=title_style
                        ),
                        html.Div(
                            [
                                html.Div(
                                ...
                                html.Div(
                                    [
                                        html.P("name: Hideyuki Ogawa　(@ogawahideyuki)"),
                                        html.P("company: Chomoku"),
                                        html.P("qualification: CMA"),
                                        html.P("challenge: Not drink Alcohol(for a year)"),
                                        html.Img(
                ...
                dcc.Tab(
                    ...
                    children=[
                        html.Div(
                            [
                                html.H1(
                                    id="overview", children="core philosophy", style=title_font
                                )
                            ],
                            style=title_style,
                        ),
                ...
                dcc.Tab(
                    ...
                    children=[
                        html.Div(
                            [
                                html.H1(
                                    id="overview", children="overview", style=title_font
                                )
                            ],
                            style=title_style,
                        ),
                        html.Div(
                            [
                                dcc.Markdown(
                                    """
                - quiz of japanese economy.
                - About Dash / Analytical web application.
                    - Today's presentation is made with Dash.
                    - With interactive visualization can watch a lot of data.
                    - Data analysis, monitoring and reporting can be done in one.
                - About Japanese economy
                    - Japanese roads have become safe.(Not talk today.)
                    - Deeply interested! Neighbour's financial circumstances.
                - epilogue
                    ...
                    children=[
                        ...
                        html.Div(
                            children=[
                                dcc.Markdown(
                                    """
                The consumption tax will be increased from October, but a reduced tax rate will be applied to grocery.How many products will be applied reduced tax rates, in next three products?

                Water bottle, Ripobitan D, Mirin
                    ...
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[
                                dcc.Markdown(
                                    """
                From 1990 to 2018, the number of car ownership in Japan is 

                1.  Increase by more than 30%

                2.  flat

                3.  decrease by more than 30%　

                [Data:　e-Stat MLIT　Automobile transport statics](https://www.e-stat.go.jp/stat-search/files?page=1&layout=datalist&toukei=00600330&kikan=00600&tstat=000001017236&cycle=1&year=20190&month=11010303&stat_infid=000031848511&result_back=1&result_page=1&tclass1val=0)
                """,
                                    style=mkd_style,
                                )
                            ],
                    ...
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[
                                dcc.Markdown(
                                    """
                From 1990 to 2014, The most grown prefecture is
                ...
                [Data: Annual report on prefectural accounts](https://www.esri.cao.go.jp/jp/sna/data/data_list/kenmin/files/files_kenmin.html)
                """,
                                    style=mkd_style,
                                )
                            ],
                                ...
                                dcc.Graph(
                                    ...
                                    figure={
                                        ...
                                        "layout": go.Layout(
                                            ...
                                            title={
                                                "text": "Prefectural GDP（1975:100 | till 1990）",
                                                "font": {"size": 50},
                                            },
                                        ),
                                    },
    ...
    if n_clicks >= 3:
        return html.Div(
            [
                ...
                Ripobitan D: 10％　Because this is medicine。Redbull and Moster are regular drinks, so 8％！

                Mirin has alcohol and 10%.
...
def quiz_car_update_graph(n_clicks, n_intervals):
    ...
    if n_clicks <= 2:
        ...
        return {
            ...
            "layout": go.Layout(width=1500, height=800, title="number of car ownership in Japan"),
        }
    elif n_clicks == 3:
        n = 1990 + n_intervals
        ...
        return {
            ...
            "layout": go.Layout(
                width=1500,
                height=800,
                title="number of car ownership in Japan",
                annotations=[
                    {
                        "x": 1990,
...
def ken_gdp_show(clickData, n_clicks):
    ...
    if n_clicks % 2 == 1:
        ...
        return {
            ...
            "layout": go.Layout(
                xaxis={"tickfont": {"size": 30}},
                title={"text": "Prefectural GDP growth rate Year: {}".format(click_year), "font": {"size": 35}},
            ),
        }
        ...
        return (
            {
                ...
                "layout": go.Layout(
                    ...
                    xaxis={"tickfont": {"size": 30}},
                    title={
                        "text": "Prefectural GDP（1990: 100 | till 2014）",
                        "font": {"size": 50},
                    },
                ),
            },
                ...
                dcc.Tab(
                    ...
                    children=[
                        html.Div(
                            [
                                html.Div(
                                    [html.H1("About Dash", style=title_font)],
                                    style=title_style,
                                ),
                                dcc.Markdown(
                                    """
                - Dash is Analytical web application.
                    - Write code with just only Python.
           ...
           \# Create a layout
            ...
            """,
                        ...
                        html.Div(
                            [
                                html.Div(
                                    [html.P("About Graph Module", style=title_font)],
                                    style=title_style,
                                ),
                                html.Div(
                                    [
                                        html.Div(
                                            [
                                                html.H3(
                                                    "Household survey from 2000 to 2019",
                                                    style={"textAlign": "center"},
                                                ),
                                                dcc.Dropdown(
                                                    id="drop1",
                ...
                dcc.Tab(
                    ...
                    children=[
                        html.Div(
                            [
                                html.Div(
                                    [html.H1("Application of each component", style=title_font)],
                                    style=title_style,
                                ),
                                # Dash_canvas
                                html.Div(
                                ...
                                html.Div(
                                    [
                                        ...
                                        dcc.Link(
                                            "Data: Kitakyushu　emergency evacuation area",
                ...
                dcc.Tab(
                        ...
                        html.Div(
                            [
                                ...
                                html.Div(
                                    [
                                        html.P(
                                            "Problem of data analysis: A gap in understanding in data analysis and difficult to share the data analysis result.",
                                            style={"fontSize": 40},
                                        ),
                                        dcc.Markdown(
                                            """
                    ### Case（imagination）
                    - Data Analysis
                        - Client: Artifical intelligence makes it easy!!!
                        - Analyst: Cooperation such as sharing domain knowledge of business is necessary
                    - sharing results
                        - Analyst: I reported to the Client!
                        - Client: There was no data I wanted to see ...
                    """,
                                            style=mkd_style,
                                        ),
                                    ],
                                ...
                                html.Div(
                                    [
                                        ...
                                        html.Div(
                                            [
                                                html.P(
                                                    "Graph seen in presentations.",
                                                    style={"fontSize": 40},
                                                ),
                                                html.P(
                                                    "Number of kyoto hotels.", style={"fontSize": 30}
                                                ),
                                                dcc.Graph(
                                                    figure={
                                                        "data": [
                                                ...
                                                dcc.Link(
                                                    "Data : Kyoto Opendata List of permitted facilities.",
                                                    href="https://data.city.kyoto.lg.jp/node/100228",
                                                    style={"marginLeft": "50%"},
                                                ),
                                                html.P(
                                                    "We can see the recent increase.",
                                                    style={"fontSize": 40},
                                                ),
                                                html.P(
                                                    "We only see is increase. => Lack of information.",
                                                    style={"fontSize": 40},
                                                ),
                                            ],
                                            style={
...
def update_chart(value1, value2, radiovalue):
    if radiovalue == "plotly.express":
        return [
            ...
            dcc.Markdown(
                """
            Graph by plotly.express   

            px.scatter(kakeichosa, x=value1, y=value2, height=600)

            [Data: e-Stat Household survey](https://www.e-stat.go.jp/stat-search?page=1&toukei=00200561&survey=%E5%AE%B6%E8%A8%88%E8%AA%BF%E6%9F%BB)
        """,
                style=mkd_style,
            ),
        ]
...
def update_graph(n_intervals, n_clicks):
    if n_clicks % 2 == 0:
        ...
        return (
            ...
            "Kyoto's hotels were built in {}: {}".format(df_kyoto_hotels["year"].min() + cnt, len(dff)),
        )
        ...
        return (
            ...
            "Kyoto's hotels were built in {}: {}".format(
...
def update_map(clickData):
    ...
    if data_x == "all":
        return (
            ...
            "Kyoto hotels as of 2018： {}".format(len(df_kyoto_hotels)),
        )
    elif data_x == 1946:
        return (
            {
        ...
        return (
            ...
            "In {}, There were build {} hotels in Kyoto.".format(data_x, dff_amount["count"].values[0]),
        )
            ...
            children=[
                dcc.Tab(
                    ...
                    children=[
                        html.Div(
                            [
                                html.Div(
                                    [html.H1("Visualize the Japanese economy.", style=title_font)],
                                    style=title_style,
                                ),
                                dcc.Markdown(
                                    """
                - Visualize the Japanese economy with Dash.
                    - Japanese roads have become safe.(Not talk today.)
                    - Deeply interested! Neighbour's financial circumstances.
                
                - Use Opendata
                    - Open data is the idea that some data should be freely available to everyone to use and republish as they wish, without restrictions from copyright, patents or other mechanisms of control.（[via Wikipedia](https://en.wikipedia.org/wiki/Open_data)）。
                    - [Japanese CIO Portal](https://cio.go.jp/en/index.php)).
                    - Problem in Japanese Official statistics.(Using improper methods)
                ...
                """,
                                ...
                                html.Div(
                                    [
                                        html.H4(
                                            "For example, there are dog registration applications.",
                                            style={"textAlign": "center"},
                                        ),
                                        dcc.Graph(
                                            figure={
                                ...
                                dcc.Link(
                                    "Data: e-Stat Eisei gyosei houkoku rei",
                ...
                dcc.Tab(
                    ...
                    children=[
                        html.Div(
                            [
                                html.Div(
                                    [html.H1("Japanese roads have become safe.", style=title_font)],
                                    style=title_style,
                                ),
                                dcc.Markdown(
                                    """
                - The number of cars in Japan is increasing.
                - Recently, There has been increase in news about Cars.
                - Are Japanese roads dangerous??
                ...
                """,
                        ...
                        html.Div(
                            ...
                            children=[
                                html.H3(
                                    "Figures related to car accidents in Japan.", style={"textAlign": "center"}
                                ),
                                dcc.Graph(
                                    figure={
                                        "data": [
                                        ...
                                        "layout": go.Layout(
                                            title={"text": "Number of accidents and injuries in Japan."}
                                        ),
                                    }
                                ),
                                dcc.Graph(
                                    figure={
                                        ...
                                        "layout": go.Layout(
                                            title={"text": "Number of traffic fatalities in Japan."}
                                        ),
                                    }
                                ),
                                dcc.Link(
                                    "Data : estat Road traffic statstics.",
                                ...
                                html.Div(
                                    [
                                        html.Div(
                                            [
                                                html.H3(
                                                    "Road fatilities per 100,000 people(world)",
                                                    style={"textAlign": "center"},
                                                ),
                                                dcc.Checklist(
                                        ...
                                        dcc.Link(
                                            "Data: OECD Road fatilities by age - extract from the IRTAD database.",
                                            href="https://stats.oecd.org/Index.aspx?DataSetCode=IRTAD_CASUAL_BY_AGE",
                                            style={"marginLeft": "30%"},
                                        ),
                                        html.H3(
                                            "Road are safe around the world!!",
                                            style={
                                                "textAlign": "center",
                                                "backgroundColor": "#fbffb9",
                                            },
                                            ...
                                            [
                                                ...
                                                dcc.Graph(
                                                    ...
                                                    figure={
                                                        ...
                                                        "layout": go.Layout(
                                                            height=600,
                                                            title="elderly traffic accident mortality",
                                                ...
                                                html.H3(
                                                    "Japan's elderly traffic accident mortality is too high...",
                                                    style={
                                                        "textAlign": "center",
                                                        "backgroundColor": "#fbffb9",
                                                        "margin": "3%",
                                        ...
                                        html.Div(
                                            [
                                                dcc.Markdown(
                                                    """
                    - Solving this problem may lead to zero death from car accidents.
                    - As is often said, there are not many elderly accidents.
                ...
                # japanese wallet
                dcc.Tab(
                    label="neighbor's financial circumstances",
                    style=tab_style,
                    selected_style=tab_selected_style,
                    children=[
                        html.Div(
                            [
                                html.Div(
                                    [html.H1("Deeply interested! Neighbour's financial circumstances.", style=title_font)],
                                    style=title_style,
                                ),
                                dcc.Markdown(
                                    """
                                - We don't know financial circumstances of the other person.
                                - There are many people, who doesn't know own financial circumstances(like me).
                                - So I investigated the Japanese financial circumstances.
                                - In addition, I investigated company data.
                                - And Salary too.
                                
                                ### Data
                                - [Japanese consumption survey](https://www.e-stat.go.jp/stat-search/database?page=1&layout=normal&toukei=00200564&survey=%E6%B6%88%E8%B2%BB%E5%AE%9F%E6%85%8B%E8%AA%BF%E6%9F%BB&result_page=1)
                                - [Statistics of Corporation](https://www.e-stat.go.jp/dbview?sid=0003060791)
                                - [Monthly Labour Survey](https://www.e-stat.go.jp/dbview?sid=0003138239)
                                ...
                                html.Div(
                                    [
                                        ...
                                        html.Div(
                                            [
                                                html.H3(
                                                    "Check household income:　Japanese consumption survey（1984‐2014）",
                                                    style={
                                                        "textAlign": "center",
                                                        "backgroundColor": "#fbffb9",
                                                    },
                                                ...
                                                html.Div(
                                                    [
                                                        html.H3(
                                                            "Check Statistics of Corporation（All industries ex financial　1960～2018）",
                                                            style={
                                                                "textAlign": "center",
                                                                "backgroundColor": "#fbffb9",
                                                            },
                                                ...
                                                html.Div(
                                                    [
                                                        html.H3(
                                                            "Monthly labour Survey:　When Japanes salary has risen？",
                                                            style={
                                                                "textAlign": "center",
                                                                "backgroundColor": "#fbffb9",
                                                            },
                                                ...
                                                html.Div([
                                                    ...
                                                    [
                                                        # 国際的な給与水準
                                                        html.H3(
                                                            "International salary trends（USD PPP 1990～）",
                                                            style={
                                                                "textAlign": "center",
                                                                "backgroundColor": "#fbffb9",
                                                            },
                                                        ...
                                                        html.P("Data: OECD (2019), Average annual wages, OECD Employment and Labour Market Statistics (database), https://doi.org/10.1787/data-00571-en (09 September 2019)")
                                                        ]),
                                                ]),
                                            ],
...
epilogue = html.Div(
    [
        html.Div([html.Div([html.H1("epilogue", style=title_font)], style=title_style)]),
        html.Div(
            [
                dcc.Markdown(
                    """
                    [SUBARU General Director Cried Out「90% of people are not good at drive」](https://business.nikkei.com/atcl/seminar/19/00105/00048/?P=4&mds)     

                    Interviewer: What is "good driving"? Where do you look at? What is your criteria?       

                    Answer: It is whether or not to care for people. Not good drivers do not care for weak people such as walking people and bicycle. Not Technique. The most important thing about driving on the road is caring for others.Right now, there are various problems in Japan, It is because we do not have that kind of education. Nobody has ever done "driving education".
                    
                    """,
                    style=mkd_style,
                ),
                html.Div(html.H3("I think this story also applies to data analysis.", style={"textAlign":"center"})),
            ],
            style=mkd_outside_style,
        ),
        html.Div([html.H1("Special Thanks: driller",  style={"fontSize": 60, "fontWeight": "bold", "textAlign": "center", "padding": 10})], style=title_style),
        html.Div(
            [
                dcc.Upload(
                    id="upload-image",
